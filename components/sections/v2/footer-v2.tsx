  ...
  return (
    ...
    >
      <div className="max-w-[1440px] mx-auto py-16 sm:py-20 lg:py-24">
        {/* Top row: Brand CTA (left) + Contact info (right) */}
        <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-16 mb-16 sm:mb-20">
          {/* Left: Brand CTA */}
          <motion.div
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-base font-semibold text-foreground/80 hover:text-accent transition-all duration-300 group py-2 px-4 -ml-4 lg:ml-0 lg:-mr-4 rounded-lg hover:bg-accent/5"
            >
        ...
        <motion.div
          ...
          className="grid grid-cols-2 sm:grid-cols-4 gap-10 sm:gap-12 lg:gap-14 mb-20 sm:mb-24"
        >
