...
export function ContactHero() {
  ...
  return (
    <section
      ref={ref}
      className="relative min-h-[60vh] flex items-end overflow-hidden px-6 sm:px-8 lg:px-16 xl:px-24 pb-20 sm:pb-28 pt-32 sm:pt-40"
    >
      {/* Parallax background */}
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto w-full">
        ...
        >
          <TextRandomized text="Get in Touch" />
        </motion.span>
